...
//no implementa iConverter, eso lo hacen  los copnverters, pero USA! un converter ( lo invoca , al q tnga conf )

public class AbstractMultiSentenceDBServiceConverter extends //
